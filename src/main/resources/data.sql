insert into user ('active', 'last_login', 'id', 'type', 'name', 'password', 'username')
...
insert into genre (id, name) values(5, 'math');
insert into genre (id, name) values(6, 'art');
insert into genre (id, name) values(7, 'illustrative');
